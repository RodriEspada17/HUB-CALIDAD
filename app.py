...
# --- CSS AVANZADO: EFECTO VERCEL CARDS ---
st.markdown("""
    <style>
    /* Ocultar el menú lateral por defecto en el Home si quieres que parezca una web real, 
       pero lo dejamos para que se vea el trabajo de agrupación */
    ...
    /* El truco del brillo al pasar el cursor (Hover) */
    .vercel-card:hover {
        border-color: #a3ff00;
        box-shadow: 0 10px 40px -10px rgba(163, 255, 0, 0.3);
    ...
    .status-badge {
        ...
        font-size: 0.75rem;
        font-weight: 700;
        margin-top: auto; /* Empuja el badge al fondo de la tarjeta */
        width: fit-content;
...
# --- CUADRÍCULA DE TARJETAS (MÓDULOS) ---
st.markdown("""
    <div class="grid-container">
        <!-- Tarjeta 1: CALIDAD (Activa y clickeable) -->
        ...
        <!-- Tarjeta 2: ELABORACIÓN (Desarrollo) -->
        ...
        <!-- Tarjeta 4: MANTENIMIENTO (Desarrollo) -->
        <div class="vercel-card">
            <div class="card-icon">🔧</div>
...
if img_b64:
    st.markdown(f"""
        <div style="
            ...
            opacity: 0.5; /* Un poco más oscuro para que no robe protagonismo a las tarjetas */
